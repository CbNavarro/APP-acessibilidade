        ...
        if (startYolo == false) {
            ...
            if (firstTimeYolo == false) {
                ...
                firstTimeYolo = true;
                    ...
                    File ids = new File("//android_asset/yolov3-tiny.cfg");
                    Log.d(TAG, "WWWWWWW: >>>>>>>>>>>>>>>>>>>>>" + ids.getAbsolutePath());

                AssetManager a = getAssets();

                String tinyYoloCfg = ids.getAbsolutePath();
                String tinyYoloWeights = "/storage/5C3E-0883/dnns/yolov3-tiny.weights";

                yolo = Dnn.readNetFromDarknet(tinyYoloCfg, tinyYoloWeights);
